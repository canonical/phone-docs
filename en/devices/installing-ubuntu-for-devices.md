...
**Warning:** Unlocking deletes all data from the device, including apps and other data. You may want to [create a backup first](installing-ubuntu-for-devices.html#backupandroid). You must first have enabled [USB Debugging](installing-ubuntu-for-devices.html#usbdebugging) in the Android OS.
