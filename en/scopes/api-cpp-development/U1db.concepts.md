...
<p>The following <a href="http://developer.ubuntu.comubuntu-15.04/qml/mobile//qml-ubuntu-components-textarea.html">TextArea</a> is for displaying contents for the current state of the global document, as defined by the key / name in the address bar.</p>
<pre class="qml">                     <span class="type"><a href="http://developer.ubuntu.comubuntu-15.04/qml/mobile//qml-ubuntu-components-textarea.html">TextArea</a></span>{
