...
The following [TextArea](http://developer.ubuntu.comubuntu-15.04/qml/mobile//qml-ubuntu-components-textarea.html) is for displaying contents for the current state of the global document, as defined by the key / name in the address bar.
