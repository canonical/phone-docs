...
<p>A Database element is also a valuable tool for cases where specific data from a repository needs to be retrieved quickly, without indexing or querying ahead of time. The 'contents' object associated with the Database element can be used together with base items such as <a href="../api-qml-current/qml-ubuntu-components-textfield.md">TextField</a> or <a href="../api-qml-current/qml-ubuntu-components-textarea.md">TextArea</a> and model-based items like ListView and <a href="../api-qml-current/qml-ubuntu-components-listitems-standard.md">ListItems.Standard</a>.</p>
