...
<p>A Database element is also a valuable tool for cases where specific data from a repository needs to be retrieved quickly, without indexing or querying ahead of time. The 'contents' object associated with the Database element can be used together with base items such as <a href="../../../apps/qml/sdk-14.10/Ubuntu.Components.TextField.md">TextField</a> or <a href="../../../apps/qml/sdk-14.10/Ubuntu.Components.TextArea.md">TextArea</a> and model-based items like ListView and <a href="../../../apps/qml/sdk-14.10/Ubuntu.Components.ListItems.Standard.md">ListItems.Standard</a>.</p>
