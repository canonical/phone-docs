...
The application uses the [ObjectModel](https://developer.ubuntu.comapps/qml/sdk-15.04.5/QtQuick.views/#objectmodel) type to access the two visual data models that it depends on.
