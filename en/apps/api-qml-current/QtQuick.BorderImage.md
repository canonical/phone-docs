...
<p>The Border Image example in <a href="QtQuick.imageelements/">Qt Quick Examples - Image Elements</a> shows how a <a href="QtQuick.imageelements.md#borderimage">BorderImage</a> can be used to simulate a shadow effect on a rectangular item.</p>
