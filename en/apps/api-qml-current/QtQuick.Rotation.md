...
For 3D-like item rotations, you must specify the axis of rotation in addition to the origin point. The following example shows various 3D-like rotations applied to an [Image](https://developer.ubuntu.comapps/qml/sdk-15.04.5/QtQuick.imageelements/#image).
...
**See also** [Dial Control example](https://developer.ubuntu.comapps/qml/sdk-15.04.5/QtQuick.customitems-dialcontrol/) and [Qt Quick Demo - Clocks](https://developer.ubuntu.comapps/qml/sdk-15.04.5/QtQuick.demos-clocks/).
