...
The following snippet shows how to use a [ScaleAnimator](index.html) together with a Rectangle item.
...
It is also possible to use the `on` keyword to tie the [ScaleAnimator](index.html) directly to an Item instance.
