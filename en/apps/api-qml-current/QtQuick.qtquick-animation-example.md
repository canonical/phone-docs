...
<p class="centerAlign"><img src="https://assets.ubuntu.com/v1/6a4b8966-qml-animations-example.png" alt="" /></p><p><i>Animation</i> is a collection of small QML examples relating to animation. Each example is a small QML file emphasizing a particular type or feature.</p>
