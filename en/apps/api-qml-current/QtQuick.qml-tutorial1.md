...
<h3 >Import</h3>
<p>First, we need to import the types that we need for this example. Most QML files will import the built-in QML types (like <a href="QtQuick.Rectangle.md">Rectangle</a>, <a href="QtQuick.imageelements.md#image">Image</a>, ..&#x2e;) that come with Qt, using:</p>
