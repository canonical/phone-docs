...
**Note:** Depending upon the plugin backend that was chosen, the search results may contain places which have further details that can be fetched on a place by place basis. To fetch these other details see [Fetching Place Details](../../sdk-15.04.1/QtLocation.location-places-cpp.md#fetching-place-details).
