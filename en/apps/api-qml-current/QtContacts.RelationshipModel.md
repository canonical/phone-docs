...
<p>There are two ways of accessing the relationship data: through model by using views and delegates, or alternatively via <a href="QtContacts.md#relationships">relationships</a> list property.</p>
