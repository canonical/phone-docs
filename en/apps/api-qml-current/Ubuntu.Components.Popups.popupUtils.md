...
<p><i>caller</i> should be given when a <a href="https://developer.ubuntu.comapps/qml/sdk-15.04.5/Ubuntu.Components.Popups.ComposerSheet/">ComposerSheet</a> or <a href="Ubuntu.Components.Popups.Dialog.md">Dialog</a> is specified using a URL and opened inside a <b>Window</b>. If not, the application's root item will be the dismiss area.</p>
...
<p>See <a href="Ubuntu.Components.Popups.Popover.md">Popover</a>, <a href="https://developer.ubuntu.comapps/qml/sdk-15.04.5/Ubuntu.Components.Popups.ComposerSheet/">ComposerSheet</a> and <a href="Ubuntu.Components.Popups.Dialog.md">Dialog</a> for their respective documentation and more examples.</p>
<!-- @@@open -->
<br/>
