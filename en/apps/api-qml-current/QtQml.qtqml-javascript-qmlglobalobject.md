...
The [XMLHttpRequest example](https://developer.ubuntu.comapps/qml/sdk-15.04.5/QtQml.xmlhttprequest/) demonstrates how to use the [XMLHttpRequest](#xmlhttprequest) object to make a request and read the response headers.
