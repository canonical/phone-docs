...
<p>The complete source code for this example is available in <a href="https://developer.ubuntu.comapps/qml/sdk-15.04.5/QtQuick.models-stringlistmodel/">examples/quick/models/stringlistmodel</a> within the Qt install directory.</p>
...
<p>The complete source code for this example is available in <a href="https://developer.ubuntu.comapps/qml/sdk-15.04.5/QtQuick.models-objectlistmodel/">examples/quick/models/objectlistmodel</a> within the Qt install directory.</p>
...
<p>The complete source code for this example is available in <a href="https://developer.ubuntu.comapps/qml/sdk-15.04.5/QtQuick.models-abstractitemmodel/">examples/quick/models/abstractitemmodel</a> within the Qt install directory.</p>
