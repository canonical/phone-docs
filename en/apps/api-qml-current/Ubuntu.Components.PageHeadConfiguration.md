...
<br/>
<!-- $$$locked -->
<table class="qmlname"><tr valign="top" id="locked-prop"><td class="tblQmlPropNode"><p><span class="name">locked</span> : <span class="type">bool</span></p></td></tr></table><p>When the <a href="#visible-prop">visible</a> property. An unlocked header automatically shows and hides if the <a href="Ubuntu.Components.Page.md">Page</a> has a flickable in which the user scrolls up or down. Default value: false</p>
