...
In order to use the camera classes a quick overview of the way a camera works is needed. If you're already familiar with this, you can skip ahead to [Camera implementation details](#camera-tldr).
...
In QML, use the [QtMultimedia.availableCameras](../QtMultimedia.QtMultimedia.md#availableCameras-prop) property:
...
In QML, you can set the `Camera` [deviceId](../QtMultimedia.Camera.md#deviceId-prop) property. All available IDs can be retrieved from [QtMultimedia.availableCameras](../QtMultimedia.QtMultimedia.md#availableCameras-prop):
...
Depending on whether you're using QML or C++, you can do this in multiple ways. In QML, you can use [Camera](../QtMultimedia.qml-multimedia.md#camera) and [VideoOutput](../QtMultimedia.VideoOutput.md) together to show a simple viewfinder:
