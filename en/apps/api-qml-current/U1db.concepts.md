...
<p>The following <a href="../sdk-14.10/Ubuntu.Components.TextArea.md">TextArea</a> is for displaying contents for the current state of the global document, as defined by the key / name in the address bar.</p>
<pre class="qml">                     <span class="type"><a href="../sdk-14.10/Ubuntu.Components.TextArea.md">TextArea</a></span>{
