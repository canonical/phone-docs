...
[Vector3dAnimation](index.html) is a specialized [PropertyAnimation](https://developer.ubuntu.comapps/qml/sdk-15.04.5/QtQuick.animation/#propertyanimation) that defines an animation to be applied when a Vector3d value changes.
