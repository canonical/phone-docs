...
The Default Property Example is a minor modification of the [Extending QML - Inheritance and Coercion Example](https://developer.ubuntu.comapps/qml/sdk-15.04.5/QtQml.referenceexamples-coercion/) that simplifies the specification of a BirthdayParty through the use of a default property.
