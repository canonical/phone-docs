...
-   ****[algorithm](#algorithm-prop)**** : string
...
<tbody>
<tr class="odd">
<td><p><span id="algorithm-prop"></span><span class="name">algorithm</span> : <span class="type">string</span></p></td>
</tr>
</tbody>
</table>
...
If no value is specified md5 will be used. If used, this should be set prior to calling the [download()](#download-method) method.
...
<tbody>
<tr class="odd">
<td><p><span id="hash-prop"></span><span class="name">hash</span> : <span class="type">string</span></p></td>
</tr>
</tbody>
</table>

This property specifies a hash to check against the downloaded file. If used, this should be set prior to calling the [download()](#download-method) method.
