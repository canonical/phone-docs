...
<p>The application uses the <a href="https://developer.ubuntu.comapps/qml/sdk-15.04.6/QtQuick.views/#objectmodel">ObjectModel</a> type to access the two visual data models that it depends on.</p>
