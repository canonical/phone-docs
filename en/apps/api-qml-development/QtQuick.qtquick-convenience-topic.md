...
Qt Quick provides the [Loader](../QtQuick.Loader.md), [Repeater](../QtQuick.Repeater.md), [ListView](../QtQuick.ListView.md), [GridView](https://developer.ubuntu.comapps/qml/sdk-15.04.6/QtQuick.draganddrop/#gridview) and [PathView](../QtQuick.PathView.md) types which also support dynamic object management, and provide a declarative API.
