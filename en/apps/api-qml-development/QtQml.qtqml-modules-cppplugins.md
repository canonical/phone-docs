...
The full source code is available in the [plugins example](https://developer.ubuntu.comapps/qml/sdk-15.04.6/QtQml.qmlextensionplugins/).

<span id="reference"></span>
Reference
---------

-   [Writing QML Extensions with C++](https://developer.ubuntu.comapps/qml/sdk-15.04.6/QtQml.tutorials-extending-qml/) - contains a chapter on creating QML plugins.
