...
<p>The full source code is available in the <a href="https://developer.ubuntu.comapps/qml/sdk-15.04.6/QtQml.qmlextensionplugins/">plugins example</a>.</p>
<h2 id="reference">Reference</h2>
<ul>
<li><a href="https://developer.ubuntu.comapps/qml/sdk-15.04.6/QtQml.tutorials-extending-qml/">Writing QML Extensions with C++</a> - contains a chapter on creating QML plugins.</li>
