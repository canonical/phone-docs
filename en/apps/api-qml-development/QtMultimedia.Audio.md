...
-   ****[itemAboutToBeInserted](#itemAboutToBeInserted-signal)****(start, end)
-   ****[itemAboutToBeRemoved](#itemAboutToBeRemoved-signal)****(start, end)
-   ****[itemChanged](#itemChanged-signal)****(start, end)
-   ****[itemInserted](#itemInserted-signal)****(start, end)
-   ****[itemRemoved](#itemRemoved-signal)****(start, end)
-   ****[loadFailed](#loadFailed-signal)****()
...
**See also** [Video](../QtMultimedia.qml-multimedia.md#video).
...
This signal is emitted when the playlist loading failed. [error](#error-signal) and [errorString](#errorString-prop) can be checked for more information on the failure.
