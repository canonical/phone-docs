...
<tbody>
<tr class="odd">
<td><p><span id="swipeArea-prop"></span><span class="qmlreadonly">[read-only] </span><span class="name">swipeArea</span> : <span class="type"><a href="Ubuntu.Components.SwipeArea.md">SwipeArea</a></span></p></td>
</tr>
</tbody>
</table>

The property specifies the [SwipeArea](../Ubuntu.Components.SwipeArea.md) attached to the component driving its behavior.
