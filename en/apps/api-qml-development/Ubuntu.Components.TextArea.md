...
This property contains the text that is displayed on the screen. May differ from the text property value when [TextEdit](../QtQuick.TextEdit.md).RichText format is selected.
...
-   [TextEdit](../QtQuick.TextEdit.md).AlignLeft (default)
-   [TextEdit](../QtQuick.TextEdit.md).AlignRight
-   [TextEdit](../QtQuick.TextEdit.md).AlignHCenter
-   [TextEdit](../QtQuick.TextEdit.md).AlignJustify
...
-   [TextEdit](../QtQuick.TextEdit.md).SelectCharacters - The selection is updated with individual characters. (Default)
-   [TextEdit](../QtQuick.TextEdit.md).SelectWords - The selection is updated with whole words.
...
-   [TextEdit](../QtQuick.TextEdit.md).AutoText
-   [TextEdit](../QtQuick.TextEdit.md).PlainText
-   [TextEdit](../QtQuick.TextEdit.md).RichText

The default is [TextEdit](../QtQuick.TextEdit.md).PlainText. If the text format is [TextEdit](../QtQuick.TextEdit.md).AutoText the text edit will automatically determine whether the text should be treated as rich text. This determination is made using Qt::mightBeRichText().
...
-   [TextEdit](../QtQuick.TextEdit.md).AlignTop (default)
-   [TextEdit](../QtQuick.TextEdit.md).AlignBottom
-   [TextEdit](../QtQuick.TextEdit.md).AlignVCenter
...
Set this property to wrap the text to the [TextEdit](../QtQuick.TextEdit.md) item's width. The text will only wrap if an explicit width has been set.

-   [TextEdit](../QtQuick.TextEdit.md).NoWrap - no wrapping will be performed. If the text contains insufficient newlines, then implicitWidth will exceed a set width.
-   [TextEdit](../QtQuick.TextEdit.md).WordWrap - wrapping is done on word boundaries only. If a word is too long, implicitWidth will exceed a set width.
-   [TextEdit](../QtQuick.TextEdit.md).WrapAnywhere - wrapping is done at any point on a line, even if it occurs in the middle of a word.
-   [TextEdit](../QtQuick.TextEdit.md).Wrap - if possible, wrapping occurs at a word boundary; otherwise it will occur at the appropriate point on the line, even in the middle of a word.

The default is [TextEdit](../QtQuick.TextEdit.md).Wrap
