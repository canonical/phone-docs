...
<p>For more details, see the <a href="QtQuick.scenegraph-customgeometry.md">Scene Graph - Custom Geometry</a>.</p>
<h4 >Preprocessing</h4>
...
<p>For more details, see the <a href="QtQuick.scenegraph-simplematerial.md">Scene Graph - Simple Material</a></p>
...
<p>The <a href="QtQuick.scenegraph-openglunderqml.md">Scene Graph - OpenGL Under QML</a> example gives an example on how to use these signals.</p>
