...
[PathInterpolator](https://developer.ubuntu.comapps/qml/sdk-15.04.6/QtQuick.animation/#pathinterpolator) provides `x`, `y`, and `angle` information for a particular `progress` along a path.
...
Typical usage of [PathInterpolator](https://developer.ubuntu.comapps/qml/sdk-15.04.6/QtQuick.animation/#pathinterpolator) is to set the progress (often via a [NumberAnimation](../QtQuick.NumberAnimation.md)), and read the corresponding values for x, y, and angle (often via bindings to these values).
