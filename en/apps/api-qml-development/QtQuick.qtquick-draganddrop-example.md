...
<p><i>GridView</i> adds drag and drop to a <a href="QtQuick.qtquick-draganddrop-example.md#gridview">GridView</a>, allowing you to reorder the list. It also uses a DelegateModel to move a delegate item to the position of another item it is dragged over.</p>
