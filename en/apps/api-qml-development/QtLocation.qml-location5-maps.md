...
<p>The following code examples are a small part of the <code>map</code> component in the <a href="QtLocation.qtlocation-mapviewer-example.md">Map Viewer (QML)</a> example. The snippets demonstrate the declaration of the <a href="QtLocation.GeocodeModel.md">GeocodeModel</a> component.</p>
...
<p>For more information on the example see the <a href="QtLocation.qtlocation-mapviewer-example.md">Map Viewer (QML)</a> example.</p>
...
<p>The above snippets are taken from the <a href="QtLocation.qtlocation-mapviewer-example.md">Map Viewer (QML)</a> example.</p>
