...
<p class="centerAlign"><img src="../../../../media/edges_qml.png" alt="" /></p><p>The baseline (not pictured above) corresponds to the imaginary line on which text would sit. For items with no text it is the same as <i>top</i>.</p>
...
<p class="centerAlign"><img src="../../../../media/edge1.png" alt="" /></p><p>You can specify multiple anchors. For example:</p>
<pre class="cpp">Rectangle { id: rect1; <span class="operator">.</span><span class="operator">.</span><span class="operator">.</span> }
...
<p class="centerAlign"><img src="../../../../media/margins_qml.png" alt="" /></p><p>The following example specifies a left margin:</p>
<pre class="cpp">Rectangle { id: rect1; <span class="operator">.</span><span class="operator">.</span><span class="operator">.</span> }
...
</td><td ><p class="centerAlign"><img src="../../../../media/anchor_ordering_bad.png" alt="" /></p></td></tr>
</table>
...
</td><td ><p class="centerAlign"><img src="../../../../media/anchor_ordering.png" alt="" /></p></td></tr>
</table>
