...
**Note:** [UbuntuListView](../Ubuntu.Components.UbuntuListView.md) has a built-in [PullToRefresh](index.html), therefore it is recommended to use [UbuntuListView](../Ubuntu.Components.UbuntuListView.md) instead of [ListView](../QtQuick.ListView.md).
