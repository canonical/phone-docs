...
<p class="centerAlign"><img src="../../../media/declarative-adv-tutorial4.gif" alt="" /></p><p>The theme change here is produced simply by replacing the block images. This can be done at runtime by changing the <a href="QtQuick.imageelements.md#image">Image</a> <code>source</code> property, so for a further challenge, you could add a button that toggles between themes with different images.</p>
...
<a class="prevPage" href="QtQuick.tutorials-samegame-samegame3.md">QML Advanced Tutorial 3 - Implementing the Game Logic</a>
</p>
