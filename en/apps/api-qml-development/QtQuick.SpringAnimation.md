...
**See also** [SmoothedAnimation](../QtQuick.SmoothedAnimation.md), [Animation and Transitions in Qt Quick](../QtQuick.qtquick-statesanimations-animations.md), [Qt Quick Examples - Animation](https://developer.ubuntu.comapps/qml/sdk-15.04.6/QtQuick.animation/), and [Qt Quick Demo - Clocks](https://developer.ubuntu.comapps/qml/sdk-15.04.6/QtQuick.demos-clocks/).
