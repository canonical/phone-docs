...
The following [TextArea](../Ubuntu.Components.TextArea.md) is for displaying contents for the current state of the global document, as defined by the key / name in the address bar.
