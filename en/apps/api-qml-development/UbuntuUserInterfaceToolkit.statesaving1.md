...
Having these preconditions, we can deduct that [MainView](../Ubuntu.Components.MainView.md)'s applicationName property is one of the properties which cannot be serialized.
