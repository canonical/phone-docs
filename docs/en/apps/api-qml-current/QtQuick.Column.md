...
<p class="centerAlign"><img src="https://assets.ubuntu.com/v1/4a18d77a-verticalpositioner_transition.gif" alt="" /></p><p><b>See also </b><a href="QtQuick.qtquick-positioning-layouts.md#row">Row</a>, <a href="QtQuick.qtquick-positioning-layouts.md#grid">Grid</a>, <a href="QtQuick.qtquick-positioning-layouts.md#flow">Flow</a>, <a href="QtQuick.Positioner.md">Positioner</a>, ColumnLayout, and <a href="QtQuick.qtquick-positioners-example.md">Qt Quick Examples - Positioners</a>.</p>
<!-- @@@Column -->
