...
<p>The balloonModel contains two types at application start which will be displayed by the <a href="QtQuick.qtquick-customitems-painteditem-example.md#balloonview">balloonView</a>. The <a href="QtQuick.qtquick-customitems-painteditem-example.md#balloonview">balloonView</a> alernates the TextBalloon delegate items between left-aligned and right-aligned.</p>
<h3 >Controls</h3>
