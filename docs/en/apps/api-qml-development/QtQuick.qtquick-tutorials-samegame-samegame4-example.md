...
<p class="centerAlign"><img src="https://assets.ubuntu.com/v1/39bd48b1-declarative-adv-tutorial4.gif" alt="" /></p><p>The theme change here is produced simply by replacing the block images. This can be done at runtime by changing the <a href="QtQuick.qtquick-imageelements-example.md#image">Image</a> <code>source</code> property, so for a further challenge, you could add a button that toggles between themes with different images.</p>
