...
<!-- $$$views-description -->
<p class="centerAlign"><img src="https://assets.ubuntu.com/v1/771826db-qml-modelviews-example.png" alt="" /></p><p><i>Views</i> is a collection of small QML examples relating to model and view functionality. They demonstrate how to show data from a model using the Qt Quick view types. For more information, visit the <a href="QtQuick.qtquick-modelviewsdata-modelview.md">Models and Views in Qt Quick</a> page.</p>
...
<p><i>ObjectModel</i> uses an <a href="QtQuick.qtquick-views-example.md#objectmodel">ObjectModel</a> for the model instead of a <a href="QtQuick.qtquick-modelviewsdata-modelview.md#listmodel">ListModel</a>.</p>
