...
<p class="centerAlign"><img src="https://assets.ubuntu.com/v1/70b1f207-audioinput-example.png" alt="" /></p><p>Qt provides the QAudioInput class to enable audio functionality within a standard application user interface.</p>
