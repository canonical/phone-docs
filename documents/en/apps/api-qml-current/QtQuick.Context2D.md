...
<p class="centerAlign"><img src="https://assets.ubuntu.com/v1/473f3d86-qml-item-canvas-context.gif" alt="" /></p><!-- @@@Context2D -->
...
<p class="centerAlign"><font color="red">[Missing image qml-item-canvas-arc.png]</font></p><p class="centerAlign"><img src="https://assets.ubuntu.com/v1/5a294c06-qml-item-canvas-startAngle.png" alt="" /></p><p>The <i>anticlockwise</i> parameter is <code>true</code> for each arc in the figure above because they are all drawn in the anticlockwise direction.</p>
...
<p class="centerAlign"><img src="https://assets.ubuntu.com/v1/496149a7-qml-item-canvas-arcTo.png" alt="" /></p><p><b>See also </b><a href="#arc-method">arc</a> and <a href="http://www.w3.org/TR/2dcontext#dom-context-2d-arcto">W3C's 2D Context Standard for arcTo()</a>.</p>
<!-- @@@arcTo -->
<br/>
<!-- $$$beginPath -->
...
<p class="centerAlign"><img src="https://assets.ubuntu.com/v1/b0951d67-qml-item-canvas-clip-complex.png" alt="" /></p><p><b>See also </b><a href="#beginPath-method">beginPath()</a>, <a href="#closePath-method">closePath()</a>, <a href="#stroke-method">stroke()</a>, <a href="#fill-method">fill()</a>, and <a href="http://www.w3.org/TR/2dcontext#dom-context-2d-clip">W3C 2d context standard for clip</a>.</p>
<!-- @@@clip -->
<br/>
<!-- $$$closePath -->
...
<p class="centerAlign"><img src="https://assets.ubuntu.com/v1/848e8650-qml-item-canvas-rotate.png" alt="" /></p><p>The rotation transformation matrix is as follows:</p>
<p class="centerAlign"><img src="https://assets.ubuntu.com/v1/f7ca72ea-qml-item-canvas-math-rotate.png" alt="" /></p><p>where the <i>angle</i> of rotation is in radians.</p>
<!-- @@@rotate -->
<br/>
<!-- $$$roundedRect -->
...
<p class="centerAlign"><img src="https://assets.ubuntu.com/v1/e2321aab-qml-item-canvas-scale.png" alt="" /></p><!-- @@@scale -->
<br/>
<!-- $$$setTransform -->
...
<p class="centerAlign"><img src="https://assets.ubuntu.com/v1/7170fa69-qml-item-canvas-math.png" alt="" /></p><p>where:</p>
<ul>
<li><code>a</code> is the scale factor in the horizontal (x) direction<p class="centerAlign"><img src="https://assets.ubuntu.com/v1/dc07df5e-qml-item-canvas-scalex.png" alt="" /></p></li>
<li><code>c</code> is the skew factor in the x direction<p class="centerAlign"><img src="https://assets.ubuntu.com/v1/08d014ff-qml-item-canvas-skewx.png" alt="" /></p></li>
<li><code>e</code> is the translation in the x direction<p class="centerAlign"><img src="https://assets.ubuntu.com/v1/20fdf253-qml-item-canvas-translate.png" alt="" /></p></li>
<li><code>b</code> is the skew factor in the y (vertical) direction<p class="centerAlign"><img src="https://assets.ubuntu.com/v1/a8bbaadb-qml-item-canvas-skewy.png" alt="" /></p></li>
<li><code>d</code> is the scale factor in the y direction<p class="centerAlign"><img src="https://assets.ubuntu.com/v1/15496315-qml-item-canvas-scaley.png" alt="" /></p></li>
<li><code>f</code> is the translation in the y direction<p class="centerAlign"><img src="https://assets.ubuntu.com/v1/a911c2e3-qml-item-canvas-translatey.png" alt="" /></p></li>
